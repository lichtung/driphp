...
/**
 * NetTelnet provides an implementation of the TELNET protocol.
 *
 * PHP version 5
 *
 * LICENSE:
 ...
 * @link        https://github.com/jnorell/NetTelnet
 *
 * @example     telnet.php  A basic line-mode telnet client using NetTelnet
 */
/**
...
class NetTelnet
{
    ...
    protected $mode = array(
        ...
        'echo_local' => true,        /* we echo to local NetTelnet user */
        ...
        'debug' => false,       /* print messages in-stream (for debugging NetTelnet) */
...
//    private $readbuf = null;
     ...
     * @return boolean     true if linefeed translation will be done
     */
     ...
     * @return string      command line interpreter prompt in use
     */
     ...
     * @return string      pager prompt in use
     */
     ...
     *
     * 'local' :    Echo commands/characters sent back to user of NetTelnet
     *
     ...
     *
     * @return string|boolean  current preferred echo mode or false on error.
     * @throws
     */
     ...
     *
     * @param int $cmd TELNET command number
     * @param int $opt TELNET command SubOption number
     ...
     *
     * @return boolean     indicates if data was written
     * @throws
     */
    function go_ahead()
    {
     ...
     * @return integer     number of bytes written to network
     * @throws
     */
     ...
     * @return string|boolean  data read or false on failure
     * @throws
     */
     ...
     *
     * @param string|array $arg command or array of command to run
     * @return string|boolean  data read or false on failure
     * @throws
     * @return
     */
     ...
     * @return   boolean             false if error detected or pattern not found
     * @throws
     */
     ...
     * @param boolean $esc escape special chars in data or not
     * @param boolean $echo echo chars when in echo_local mode
     * @return boolean     false if error detected
     * @throws
     */
    function send($data = null)
    {
        ...
        if ($this->mode['telnet_bugs'])
            $ret = (($this->net_write()) > 0) ? true : false;
        $this->go_ahead();
        return $ret;
    }
