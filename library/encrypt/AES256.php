...
class AES256
{
    ...
    private static function sub_word($word)
    {
        return self::$sbox0[$word & 0x000000FF] | self::$sbox1[$word & 0x0000FF00] | self::$sbox2[$word & 0x00FF0000] | self::$sbox3[$word & 0xFF000000];
    }
