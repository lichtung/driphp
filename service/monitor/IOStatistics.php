...
class IOStatistics
{
     ...
     */
    protected $cpuReport = [
        'user' => 0.0,# 用户进程所占用的CPU时间比重 | Show the percentage of CPU utilization that occurred while executing at the user level (application).
    ...
    /**
     * The second report generated by the iostat command is the Device Utilization Report. The device report provides statistics on a per physical device or partition basis. Block devices and
